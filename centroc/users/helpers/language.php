...
$lang = array_merge($lang,array(
	"SIGNUP_TEXT"			=> "Crea tu Cuenta",
	"SIGNUP_BUTTONTEXT"		=> "Registrame",
	"SIGNUP_AUDITTEXT"		=> "Registrado",
	));

// Signin
$lang = array_merge($lang,array(
	"SIGNIN_FAIL"			=> "** FALLO INICIO DE SESION **",
	"SIGNIN_TITLE"			=> "Iniciar sesión",
	"SIGNIN_TEXT"			=> "Ingresa",
	"SIGNOUT_TEXT"			=> "Salir",
	"SIGNIN_BUTTONTEXT"		=> "Ingresa",
	"SIGNIN_AUDITTEXT"		=> "Has iniciado sesion",
	"SIGNOUT_AUDITTEXT"		=> "Has cerrado tu sesion",
	));

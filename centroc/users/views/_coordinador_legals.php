  ...
  <div class="page-header float-right">
    <div class="page-title">
      <ol class="breadcrumb text-right">
        ...
        <li>Maneja</li>
        <li class="active">Asesoria legal</li>
      </ol>
    </div>
  </div>
</div>
...
<h2>Asesoria Legal</h2><br>
  <div>
    <table class="table table-list-search table-hover requestsTable" style="width:100%;" id="legalTable">
...
<br><h3>Reportes</h3><br>
  <div class="reports">
    <table class="table table-list-search table-hover reportsTable" id="legalTableReport" >
      <thead class="bg-dark fwhite"><tr class="text-center">
        <th></th>
        <th>Asunto</th>
        <th>Nombre</th>
...
var table = $('.requestsTable').DataTable({
        "ajax": {
            "url": "server_processing.php?view=legals",
            "data": function ( d ) {
                d.myKey = "legals";
            },
            dataSrc:""
...
$('.reportsTable tfoot th').each( function () {
  ...
  buttons: [{
      extend: 'excel',
      text: 'Excel',
      title: 'Reporte Solicitudes Asesoria Legal'
  },
  {
      extend: 'pdf',
      text: 'PDF',
    ...
    "ajax": {
        "url": "server_processing.php?view=legals&reports=true",
        "data": function ( d ) {
            d.myKey2 = "legals";
        },
        dataSrc:""

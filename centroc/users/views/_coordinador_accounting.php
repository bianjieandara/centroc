  ...
  <div class="page-header float-right">
    <div class="page-title">
      <ol class="breadcrumb text-right">
        ...
        <li>Maneja</li>
        <li class="active">Asesoria Contable</li>
      </ol>
    </div>
  </div>
</div>
...
<div>
    <table class="table table-list-search table-hover requestsTable" style='width:100%;' id="accountingTable">
      ...
      <br><h3>Reportes</h3><br>
        <div class="reports">
          <table class="table table-list-search table-hover reportsTable" style="width:100%;" id="accountingTableReport" >
...
var table = $('.requestsTable').DataTable({
        "ajax": {
            "url": "server_processing.php?view=accounting",
            dataSrc:""
        },
        "columns": [
            {
...
$('.reportsTable tfoot th').each( function () {
  ...
  buttons: [{
      extend: 'excel',
      text: 'Excel',
      title: 'Reporte Solicitudes Asesoria Contable'
  },
  {
      extend: 'pdf',
      text: 'PDF',
    ...
    "ajax": {
        "url": "server_processing.php?view=accounting&reports=true",
        dataSrc:""
    },
    "columns": [
        {

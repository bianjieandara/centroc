  ...
  <div class="page-header float-right">
    <div class="page-title">
      <ol class="breadcrumb text-right">
        ...
        <li>Maneja</li>
        <li class="active">Recreadores</li>
      </ol>
    </div>
  </div>
</div>
...
<h2>Solicitudes de Recreadores</h2><br>
<div>
    <table class="table table-list-search table-hover requestsTable" id="recreationTable">
      ...
      <br><h3>Reportes</h3><br>
        <div class="reports">
          <table class="table table-list-search table-hover reportsTable" id="recreationTableReport" >
            <thead class="bg-dark fwhite"><tr class="text-center">
              <th></th>
              <th>Nombre</th>
              <th>Usuario</th>
      ...
      var table = $('.requestsTable').DataTable({
        "ajax": {
            "url": "server_processing.php?view=recreation",
            dataSrc:""
        },
        "columns": [
            {
      ...
      extend: 'excel',
      text: 'Excel',
      title: 'Reporte Solicitudes Recreadores'
      },
      {
      extend: 'pdf',
      text: 'PDF',
      ...
      "ajax": {
        "url": "server_processing.php?view=recreation&reports=true",
        dataSrc:""
      },
      "columns": [
        {

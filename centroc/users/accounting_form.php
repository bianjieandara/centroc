							...
							<div class="col-12">
									<nav aria-label="breadcrumb">
											<ol class="breadcrumb">
													...
													<li class="breadcrumb-item"><a href="<?=$us_url_root?>users/legals.php">Asesoria Contable</a></li>
...
<section class="section-padding-80-0">
	...
	<div class="row align-items-md-center">
		...
		<form class="consult-form py-5" action="legals_form.php" method="POST">
				...
				<div class="col-md-12">
				<div class="form-group mb-4">
				<input class="btn crose-btn fa fa-input" type="submit" value="&#xf073 &nbsp;SOLICITAR" name="request_accounting">
				</div>
				</div>
				</div>
		</form>

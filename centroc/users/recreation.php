							...
							<div class="col-12">
									<nav aria-label="breadcrumb">
											<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">Recreacion</li>
											</ol>
									</nav>
							</div>
					</div>
...
<div class="bg-gray section-padding-80">
	<div class="container">
		...
		<div class="col-md-3 vcenter">
			<div class="text-left">
			<a href="dates_form.php?view=recreation" class="btn crose-btn" data-animation="fadeInUp" data-delay="500ms"><i class="fa fa-calendar fa-lg" aria-hidden="true"></i> SOLICITAR</a>
			</div>
		</div>
	</div>
</div>
